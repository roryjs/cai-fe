...
function TrekkingChuluWest() {
  return (
    <div>
      <Head>
        <title>Compare Chulu West Travel Insurance</title>
      </Head>
      ...
      <Container className="main-container text-container" size="xl">
        <Title align="center">Chulu West Travel Insurance</Title>
        <Text>
          <p>
            Chulu West is a beautiful trekking peak located in the Annapurna
            region of Nepal, standing at an altitude of 6,419 meters (21,055
            feet). It offers stunning views of the surrounding peaks, including
            Annapurna and Dhaulagiri.
          </p>
        </Text>
        <Title order={2}>Trekking or Climbing?</Title>
        <Text>
          Chulu West is also classified by the Nepal Mountaineering Association
        ...
        <Text>
          As Chulu West involves some climbing and mountaineering, standard
          trekking insurance may not necessarily cover you. You will need
          mountaineering insurance that covers up to 6,419 meters to ensure you
          are fully covered. Some insurers may offer coverage for Chulu West
...
export default TrekkingChuluWest;
