...
function TrekkingKyajoRi() {
  return (
    <div>
      <Head>
        <title>Compare Kyajo Ri Travel Insurance</title>
      </Head>
      ...
      <Container className="main-container text-container" size="xl">
        <Title align="center">Kyajo Ri Travel Insurance</Title>
        <Text>
          <p>
            Kyajo Ri is a popular trekking peak located in the Solu-Khumbu
            region of Nepal, standing at an altitude of 6,186 meters (20,298
            feet). It offers breathtaking views of the surrounding mountains,
            including Mount Everest, Cho Oyu, and Makalu.
          </p>
        </Text>
        <Title order={2}>Trekking or Climbing?</Title>
        <Text>
          Kyajo Ri is also classified by the Nepal Mountaineering Association
          (NMA) as a "Trekking peak". However, it requires more than just
          trekking to climb! You will need to have some basic mountaineering
          skills and experience, including using crampons, an ice axe, and a
          climbing harness.
        </Text>
        <Title order={2}>What insurance do I need?</Title>
        <Text>
          As Kyajo Ri involves some climbing and mountaineering, standard
          trekking insurance may not necessarily cover you. You will need
          mountaineering insurance that covers up to 6,186 meters to ensure you
          are fully covered. Some insurers may offer coverage for Kyajo Ri under
          "Trekking" insurance, which could be less expensive than
...
export default TrekkingKyajoRi;
